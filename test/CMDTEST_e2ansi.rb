...
"
  ...
  def test_plain_file
    cmd_e2ansi_cat("#{__dir__}/files/hello/hello.c") do
      ...
      stdout_equal("\
\e[38;5;124m/*\e[0m
\e[38;5;124m * Demonstration of \"e2ansi\" -- a tool\e[0m
\e[38;5;124m * that exports the syntax highlighting\e[0m
\e[38;5;124m * performed by Emacs to tools like \"less\".\e[0m
\e[38;5;124m */\e[0m
...
")
  ...
  def test_colors_silence_talky_major_modes
    cmd_e2ansi_cat("--colors 16",
                   "#{__dir__}/files/test-shell.sh") do
      stdout_equal(["\e[31m# This is a shell script file\e[0m"])
    end
  end
end
